		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ordersmanagementworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ordersmanagementworkflowuimodule-display": {
								"semanticObject": "ordersmanagementworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ordersmanagement.workflowuimodule",
									"url": sap.ui.require.toUrl("ordersmanagement/workflowuimodule")
								}
							}
						}
					}
